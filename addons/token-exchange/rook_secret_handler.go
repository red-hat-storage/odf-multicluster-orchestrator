...
func (r RookSecretHandler) createBlueSecret(name string, namespace string, c *blueSecretTokenExchangeAgentController) error {
	// fetch secret
	...
	sc, err := getStorageClusterFromRookSecret(c.spokeKubeConfig, secret)
	if err != nil {
...
func (r RookSecretHandler) createGreenSecret(name string, namespace string, c *greenSecretTokenExchangeAgentController) error {
...
func getStorageClusterFromRookSecret(spokeKubeConfig *rest.Config, secret *corev1.Secret) (storageCluster string, err error) {
