...
func TestGetBasePath(t *testing.T) {
	cases := []struct {
		...
		{
			name:             "OCP 4.22 should use compatibility base path",
			clusterVersion:   "4.22.0",
			expectedBasePath: COMPATIBILITY_BASE_PATH,
		},
		{
			name:             "OCP 4.22 nightly should use compatibility base path",
			clusterVersion:   "4.22.0-0.nightly-2026-05-28-111510",
			expectedBasePath: COMPATIBILITY_BASE_PATH,
		},
	}
	for _, c := range cases {
