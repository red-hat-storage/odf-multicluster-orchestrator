...
func getFakeMirrorPeerReconciler(mirrorpeer *multiclusterv1alpha1.MirrorPeer) MirrorPeerReconciler {
	...
	r := MirrorPeerReconciler{
		...
		SyncInternalSecret: func(_ context.Context, _ client.Client, _ *runtime.Scheme, _ string, _ *corev1.Secret, _ *multiclusterv1alpha1.MirrorPeer, _ *slog.Logger) error {
			return nil
		},
	}
	return r
