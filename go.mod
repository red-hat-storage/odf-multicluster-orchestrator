...
require (
	...
	github.com/noobaa/noobaa-operator/v5 v5.0.0-00010101000000-000000000000 // indirect
...
replace (
	...
	github.com/openshift/api => github.com/openshift/api v0.0.0-20220905103941-66f8283afa3b
