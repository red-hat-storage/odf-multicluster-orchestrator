...
require (
	...
	github.com/submariner-io/submariner-operator v0.15.4
...
require (
	...
	github.com/submariner-io/admiral v0.15.4 // indirect
	github.com/submariner-io/submariner v0.15.4 // indirect
