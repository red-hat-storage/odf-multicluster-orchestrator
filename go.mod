...
replace (
	...
	// To take in the latest rook changes, point to "release-4.20" branch in red-hat-storage/rook fork.
	github.com/rook/rook/pkg/apis => github.com/red-hat-storage/rook/pkg/apis v0.0.0-20260312064938-ac5e5cc47659
