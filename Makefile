...
# odf.openshift.io/odf-multicluster-orchestrator-bundle:$VERSION and odf.openshift.io/odf-multicluster-orchestrator-catalog:$VERSION.
IMAGE_TAG_BASE ?= odf.openshift.io/odf-multicluster-orchestrator
